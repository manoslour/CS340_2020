...
%type <exprNode> lvalue tableitem primary assignexpr call term tablemake expr elist indexed indexedelem const stmt ifstmt
...
ifprefix : IF L_PAR expr R_PAR          {
                                          fprintf(fp, "ifprefix: IF L_PAR expr R_PAR at line %d --> %s\n", yylineno, yytext);
